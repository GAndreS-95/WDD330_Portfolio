...
let town_Name = document.querySelector("#townID").textContent;
let townId;
...
const apiURL2 = "//api.openweathermap.org/data/2.5/forecast?id=" + [townid] + "&appid=f11edeb9ff4d88ed0eeaf0ebcbc06bb8&units=imperial"
    ...
    let mylist = weatherInfo.list;
      ...
      for (i=0; i<mylist.length; i++) {
        ...
        if (time.includes('18:00:00')){
          ...
          document.querySelector("section.weatherforecast").appendChild(theDay);
        }
      }
 });